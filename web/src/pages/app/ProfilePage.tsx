    ...
    <div className="app-page">
      <header className="app-page-header">
        <div>
          ...
          <p>Review the information that drives your strategy recommendation.</p>
        </div>
      </header>
      ...
      <div className="app-two-column">
        <section className="app-panel">
          <div className="section-heading">
            <h2>Account</h2>
            <p>Basic authenticated user information.</p>
          </div>
        ...
        <section className="app-panel">
          <div className="section-heading">
            ...
            <p>Saved onboarding inputs used to generate the strategy.</p>
          </div>
          <div className="review-grid">
