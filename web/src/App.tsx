    ...
    <div className="page-shell">
      ...
      <header className="hero-card">
        <div className="hero-copy">
          ...
          <h1>Market-aware portfolio planning for long-term financial goals.</h1>
          <p>
            Build a personalized strategy from client inputs, adapt it to the current
            market regime, and estimate the probability of success through simulation.
          </p>
        </div>
        <div className="hero-panel">
          <span>Core output</span>
          <strong>{percentFormatter.format(probability)}</strong>
          <p>probability of reaching the target goal under simulated market paths</p>
        </div>
      </header>
      ...
      <main className="layout-grid">
        <section className="panel form-panel">
          <div className="section-heading">
            ...
            <p>Simulate a long-term investor and generate a portfolio strategy.</p>
          </div>
          ...
          <div className="insight-grid">
            <section className="panel recommendation-panel">
              <div className="section-heading">
                ...
                <p>
                  The system combines user preferences with market-aware allocation rules.
                </p>
              </div>
              ...
              <ul className="reason-list">
                ...
                <li>
                  Adjusts exposure based on the current market regime:
                  {" "}
                  {advice.market_regime.replace("_", " ")}.
                </li>
                <li>
                  Prioritizes
                  {" "}
                  {allocationEntries[0]?.name}
                  {" "}
                  and
                  {" "}
                  {allocationEntries[1]?.name}
                  {" "}
                  in the recommended mix.
                </li>
          ...
          <div className="bottom-grid">
            <section className="panel compact-panel">
              <div className="section-heading">
                ...
                <p>Base strategy versus market-aware recommendation.</p>
              </div>
              <div className="comparison-grid">
                <ComparisonTile
                  label="Base return"
                  value={percentFormatter.format(advice.base_strategy.expected_annual_return)}
                />
                <ComparisonTile
                  label="Recommended return"
                  value={percentFormatter.format(
                    advice.recommended_strategy.expected_annual_return,
                  )}
                />
                <ComparisonTile
                  label="Base volatility"
                  value={percentFormatter.format(advice.base_strategy.annual_volatility)}
                />
                <ComparisonTile
                  label="Recommended volatility"
                  value={percentFormatter.format(
                    advice.recommended_strategy.annual_volatility,
                  )}
                />
              </div>
            </section>
            ...
            <section className="panel compact-panel">
              <div className="section-heading">
                ...
                <p>Plain-English explanation for the end user.</p>
              </div>
              <p className="narrative-copy">{advice.explanation}</p>
            </section>
          </div>
        </section>
      </main>
